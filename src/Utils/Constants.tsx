...
export const cityStateData = [
  ...
  {state: 'Chandigarh', city: [{id: '43', city: 'Chandigarh'}]},
  {
    state: 'Odisha',
    city: [
  ...
  {state: 'Karnatka', city: [{id: '103', city: 'Mysore'}]},
  {
    state: 'Mizoram',
    city: [
      {id: '121', city: 'Aizawl'},
  ...
  {state: 'Dadra and Nagar Haveli', city: [{id: '1128', city: 'Silvassa'}]},
];
